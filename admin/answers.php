            ...
            <table class="table table-hover" id="dataTable">
                ...
                <?php
                    while($row=$result->fetch_assoc())
                    {
                        ...
                        echo '<td><input type="checkbox" name="chk[]" value="'.$row["ans_id"].'"></td>';
                        echo '<td>'.$row["ans_desc"] .'</td>';
                        echo '<td>'.$row["fk_email_id"] .'</td>';
                        echo '<td><img class="img-responsive img-thumbnail" src="'.$row["ans_img"].'"></td>';
                        echo '<td align="center"><a href="answerdetails.php?ansid='.$row["ans_id"].'"><i class="icon-eye-open">  View More</a></i></td>';
